      ...
      {projects.map((project)=>(
        <div key={project.id} onClick={()=> handleOpenModal(project)} className='border border-white bg-gray-900 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden cursor-pointer hover:shadow-purple-500/50 hover:-translate-y-2 transition-transform duration-300'>
          ...
          <div className='p-6'>
            ...
            <p className='text-gray-500 mb-3 pt-5 lg:pt-2 line-clamp-3 lg:line-clamp-2'>
              {project.description}
            </p>
            <div className='mb-4'>
      ...
      {selectedProject && (
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4'>
          ...
          <div className='lg:p-8 p-6'>
            ...
            ) : (                          // If only one button, then it takes full width
              <>
                {selectedProject.github && (
                  <a
                    ...
                    target='_blank'
                    rel='noopener noreferrer'
                    className='w-full bg-gray-800 hover:bg-purple-800 text-gray-400 lg:px-6 lg:py-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center'
                  >
                    View Code
                  </a>
                )}
                {selectedProject.webapp && (
                  <a
                    ...
                    target='_blank'
                    rel='noopener noreferrer'
                    className='w-full bg-purple-600 hover:bg-purple-800 text-gray-400 lg:px-6 lg:py-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center'
                  >
                    View Live
                  </a>
                )}
