...
const Experience = () => {
  return (
    <section id='experience' className='py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[8vw] font-sans bg-skills-gradient clip-path-custom-2'>
    ...
    <div className='text-center mb-16'>
      ...
      <p className='text-gray-400 mt-4 text-lg font-semibold'>A collection of my work & internship experience and the roles I have taken in various organizations</p>
    </div>
    ...
    {experiences.map((experience, index) =>(
      <div key={experience.id} className={`flex flex-col sm:flex-row items-center mb-16 ${index % 2 === 0 ? "sm:justify-end" : "justify-start"}`}>
    {/* Timeline Circle */}
    ...
    <div className= {`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] ${
              ...
              } sm:ml-44 sm:mr-44 ml-8 lg:ml-[11vw] lg:mr-[11vw] transform transition-transform duration-300 hover:scale-105`}>
